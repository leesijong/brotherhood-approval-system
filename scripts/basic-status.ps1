...
if (Test-Path "C:\cckbm") { Write-Host "  ✓ Project Root" -ForegroundColor Green }
if (Test-Path "C:\cckbm\backend") { Write-Host "  ✓ Backend Directory" -ForegroundColor Green }
if (Test-Path "C:\cckbm\brotherhood") { Write-Host "  ✓ Frontend Directory" -ForegroundColor Green }
