...
if (Test-Path $projectRoot) { Write-Host "  ✓ Project Root" -ForegroundColor Green }
if (Test-Path $backendPath) { Write-Host "  ✓ Backend Directory" -ForegroundColor Green }
if (Test-Path $frontendPath) { Write-Host "  ✓ Frontend Directory" -ForegroundColor Green }
