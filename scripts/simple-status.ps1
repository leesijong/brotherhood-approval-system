# Brotherhood System Simple Status Check
...
Write-Host "Development Tools Check:" -ForegroundColor Blue
...
if ($javaProcesses) {
    ...
    foreach ($process in $javaProcesses) {
        Write-Host "     - PID: $($process.Id), Memory: $([math]::Round($process.WorkingSet64/1MB, 2))MB" -ForegroundColor Cyan
    }
} else {
...
Write-Host "  .\scripts\simple-start.ps1 help    # Show help" -ForegroundColor Cyan
